...
class Emojifier {
    ...
    /** THE BELOW VARIABLE IS NO LONGER NECESSARY WITH TIMBER
     * private static final String LOG_TAG = Emojifier.class.getSimpleName(); */


    private static final float EMOJI_SCALE_FACTOR = .9f;
    private static final double SMILING_PROB_THRESHOLD = .15;
    //EYE OPEN PROB THRESHOLD è da testare su un dispositivo reale, non posso su emulatore,
    //N.B. il valore potrebbe cambiare.
